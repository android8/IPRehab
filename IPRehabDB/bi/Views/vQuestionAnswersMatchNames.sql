...
CREATE view [bi].[vQuestionAnswersMatchNames]
as
select distinct e.PatientICNFK , e.FacilityID6--e.EpisodeOfCareID, , convert(varchar, a.LastUpdate, 101) lastUpdate
...
[vhaausbi13].[DMTreatingSpecialty].[dbo].[rptRehabDetails] P on 
   ...
   where p.PatientName is not null /*231 pat, 16247 ans*/ 
   --and e.FacilityID6 not like '648%'
