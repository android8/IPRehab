...
export class Utility implements ICommonUtility {
    ...
    public getCRUD($thisPersistable: any, oldAnswer: string, newAnswer: string): EnumDbCommandType {
        ...
        const noOld: boolean = +oldAnswer <= 0 || oldAnswer === undefined || oldAnswer === null || oldAnswer === '';
        const hadOld: boolean = +oldAnswer > 0;
        const noNew: boolean = +newAnswer <= 0 || newAnswer === undefined || newAnswer === null || newAnswer === '';
