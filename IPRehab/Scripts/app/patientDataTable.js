$(function () {
    ...
    const groupColumn = 1; //group by column 2 (column index 1)
    const targetTable = $('table.patients');
    //dom options
    const uploadButtonStyle = '<"btn primary #u">';
    const downloadButtonStyle = '<"btn primary #d">';
    ...
    const navArrangement = '<"row"<"col-md-2 col-sm-3"l>' +
    ...
    const navButtons2 = ['copy', 'csv', 'excel', 'pdf'];
    let collapsedGroups = {};
