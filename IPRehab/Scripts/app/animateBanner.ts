...
const sliderController = (function () {
    const sFooterHeight: string = $(".footer").css("height");
    const sBannerHeight: string = $("banner").css("height");
    const iBannerHeight: number = parseInt(sBannerHeight);
    let bannerFooterVisible: boolean;
