...
$(function () {
    ...
    (function GG0170Q_addListner() {
        ...
        /* on change */
        let seenTheDialog = true;
        const GG0170Qs = $('.persistable[id^=GG0170Q_]');
        GG0170Qs.each(function () {
            ...
            thisQ.on('change', { x: EnumChangeEventArg.Change }, function (e) {
                ...
                const Q_admission_is_No = thisQ.prop('id').indexOf('Admission_Performance') >= 0 && thisQ.prop('id').indexOf('No') >= 0 && thisQ.prop('checked');
                //const Q_admission_is_Yes: any = $('.persistable[id^=GG0170Q][id*=Admission_Performance][id*=Yes]:checked');
                const Q_admission_is_Yes = thisQ.prop('id').indexOf('Admission_Performance') >= 0 && thisQ.prop('id').indexOf('Yes') >= 0 && thisQ.prop('checked');
                //const Q_discharge_is_No: any = $('.persistable[id^=GG0170Q][id*=Discharge_Performance][id*=No]:checked');
                const Q_discharge_is_No = thisQ.prop('id').indexOf('Discharge_Performance') >= 0 && thisQ.prop('id').indexOf('No') >= 0 && thisQ.prop('checked');
                //const Q_discharge_is_Yes: any = $('.persistable[id^=GG0170Q][id*=Discharge_Performance][id*=Yes]:checked');
                const Q_discharge_is_Yes = thisQ.prop('id').indexOf('Discharge_Performance') >= 0 && thisQ.prop('id').indexOf('Yes') >= 0 && thisQ.prop('checked');
                const Q_interim_is_No = thisQ.prop('id').indexOf('Interim_Performance') >= 0 && thisQ.prop('id').indexOf('No') >= 0 && thisQ.prop('checked');
                const Q_interim_is_Yes = thisQ.prop('id').indexOf('Interim_Performance') >= 0 && thisQ.prop('id').indexOf('Yes') >= 0 && thisQ.prop('checked');
                const Q_followUp_is_No = thisQ.prop('id').indexOf('Follow_Up_Performance') >= 0 && thisQ.prop('id').indexOf('No') >= 0 && thisQ.prop('checked');
    ...
    (function J0510_J0520_addListener() {
        ...
        J0510_J0520.each(function () {
            ...
            thisJ.on('change', function () {
                const selectedOptions = $('.persistable[id^=J0510_] :selected, .persistable[id^=J0520_] :selected');
